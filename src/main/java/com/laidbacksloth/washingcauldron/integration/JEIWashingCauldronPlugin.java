...
public class JEIWashingCauldronPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts (IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(Items.CAULDRON), RecipeType.create(WashingCauldron.MOD_ID, "cauldron_washing", CauldronWashingRecipe.class));
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(new RecipeType<>(CauldronWashingRecipeCategory.UID, CauldronWashingRecipe.class), recipes);
    }
}
